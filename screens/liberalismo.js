...
const Liberalismo = ({navigation}) =>{
    ...
    const DATA = {
        ...
        impuestos: {
            ...
            definition:  <Text style={styles.textLiberalismo}><Text style={styles.textYellow}>Dependiendo</Text> de la <Text style={styles.textYellow}>sociedad</Text> donde nos encontremos, veremos distintos tipos de <Text style={styles.textYellow}>impuestos</Text>, sin embargo el que existan muchos impuestos <Text style={styles.textYellow}>no</Text> es sinónimo de <Text style={styles.textYellow}>mayor eficiencia</Text> del <Text style={styles.textYellow}>Estado</Text>. Los <Text style={styles.textYellow}>impuestos</Text> en estricto rigor son un <Text style={styles.textYellow}>robo</Text>, de ahí su nombre , nos <Text style={styles.textYellow}>imponen</Text> a dar parte del fruto de <Text style={styles.textYellow}>nuestro</Text> que se traduce en <Text style={styles.textYellow}>dinero</Text>, es decir, menos <Text style={styles.textYellow}>capacidad adquisitiva</Text> para los ciudadanos con la finalidad y la <Text style={styles.textYellow}>supuesta garantía</Text> de un correcto funcionamiento del poder del Estado. Sin embargo, el poder corrompe y más cuando está en manos de un burócrata. Por todo lo anterior mencionado es <Text style={styles.textYellow}>vital</Text> que exista un <Text style={styles.textYellow}>equilibrio</Text> en esta materia para que el sistema <Text style={styles.textYellow}>Económico</Text> y Polítco funcione correctamente. </Text>,
