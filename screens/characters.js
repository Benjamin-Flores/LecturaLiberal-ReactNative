...
const DATA = [
  ...
  },
  {
    ...
    data: [
      ...
      countryFlag: <Image style={styles.flag} source={require('../assets/fotosPersonajes/Banderas/banderaeeuu.png')} />,
      date: '1921-2002',
      bio: 'John Rawls fue filósofo estadounidense, profesor de filosofía política en la Universidad de Hardvard. Su vida estuvo encarnada al respeto a la Humanidad, principio que impartía a través de su pensamiento original y sorpendente combinación de libertad e igualdad, animado por la tolerancia y la democrática confianza en las posibilidades humanas.',
      ...
      specialImage: <Image style={styles.specialImage} source={require('../assets/fotosPersonajes/MarcoEspecial/johnrawls1.jpg')} />,
  ...
  },
  {
    ...
    data: [
      ...
      sentence: 'Hay dos modelos de sociedad: el Capitalismo que premia el esfuerzo, las ganas de progresar o el Socialismo, donde un conjunto de envidiosos quieren expropiarle el fruto de su trabajo al que le va bien.',
